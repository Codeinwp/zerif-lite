<?php
	...
	if(isset($zerif_bottomribbon_text) && $zerif_bottomribbon_text != ""):
		echo '<section class="separator-one">';
			echo '<div class="color-overlay">';
				...
				if(isset($zerif_bottomribbon_buttonlabel) && $zerif_bottomribbon_buttonlabel != "" && isset($zerif_bottomribbon_buttonlink) && $zerif_bottomribbon_buttonlink != ""):
