<?php
	...
	if ( ! zerif_check_if_old_version_of_theme() && current_user_can( 'edit_theme_options' ) ) {
		$zerif_bottomribbon_text = get_theme_mod( 'zerif_bottomribbon_text', sprintf( __( 'Change this text in %s','zerif-lite' ), sprintf( '<a href="%1$s">%2$s</a>', esc_url( admin_url( 'customize.php?autofocus&#91;control&#93;=zerif_bottomribbon_text' ) ), __( 'BottomButton Ribbon','zerif-lite' ) ) ) );
