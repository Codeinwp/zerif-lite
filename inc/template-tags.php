...
function zerif_our_focus_header_title_function() {
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		$zerif_ourfocus_title = get_theme_mod( 'zerif_ourfocus_title', sprintf( __( 'Change this title in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_ourfocus_title' ) ).'">%s</a>', __( 'Our focus section','zerif-lite' ) ) ) );
	} else {
...
function zerif_our_focus_header_subtitle_function() {
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		$zerif_ourfocus_subtitle = get_theme_mod( 'zerif_ourfocus_subtitle', sprintf( __( 'Change this subtitle in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_ourfocus_subtitle' ) ).'">%s</a>', __( 'Our focus section','zerif-lite' ) ) ) );
	} else {
...
function zerif_our_team_header_title_function() {
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		$zerif_ourteam_title = get_theme_mod( 'zerif_ourteam_title', sprintf( __( 'Change this title in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_ourteam_title' ) ).'">%s</a>', __( 'Our team section','zerif-lite' ) ) ) );
	} else {
...
function zerif_our_team_header_subtitle_function() {
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		$zerif_ourteam_subtitle = get_theme_mod( 'zerif_ourteam_subtitle', sprintf( __( 'Change this subtitle in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_ourteam_subtitle' ) ).'">%s</a>', __( 'Our team section','zerif-lite' ) ) ) );
	} else {
...
function zerif_testimonials_header_title_function() {
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		$zerif_testimonials_title = get_theme_mod( 'zerif_testimonials_title', sprintf( __( 'Change this title in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_testimonials_title' ) ).'">%s</a>', __( 'Testimonials section','zerif-lite' ) ) ) );
	} else {
...
function zerif_big_title_text_function() {
	...
	if( ! empty ( $zerif_bigtitle_title_default ) ) {
		...
		$zerif_bigtitle_title = get_theme_mod ( 'zerif_bigtitle_title_2', sprintf( __( 'This piece of text can be changed in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_bigtitle_title' ) ).'">%s</a>', __( 'Big title section','zerif-lite' ) ) ) );
...
function zerif_about_us_header_title_function() {
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		$zerif_aboutus_title = get_theme_mod( 'zerif_aboutus_title', sprintf( __( 'Change this title in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_aboutus_title' ) ).'">%s</a>', __( 'About us section','zerif-lite' ) ) ) );
	} else {
...
function zerif_about_us_header_subtitle_function() {
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		$zerif_aboutus_subtitle = get_theme_mod( 'zerif_aboutus_subtitle', sprintf( __( 'Change this subtitle in %s','zerif-lite' ), sprintf( '<a href="'.esc_url( admin_url( 'customize.php?autofocus[control]=zerif_aboutus_subtitle' ) ).'">%s</a>', __( 'About us section','zerif-lite' ) ) ) );
	} else {
