...
class Zerif_Welcome {
	...
	public function zerif_lite_welcome_scripts_for_customizer() {
		...
		$zerif_arg_array = array(
			'nr_actions_required' => $nr_actions_required,
			'customizerpage' => esc_url( admin_url( 'customize.php#actions_required' ) ),
		);

		if( !isset( $_GET['theme'] ) || ( isset( $_GET['theme'] ) && ( $_GET['theme'] != 'zerif-lite' ) ) ) {
			$zerif_arg_array = array(
				'nr_actions_required' => $nr_actions_required,
		...
		wp_localize_script( 'zerif-lite-welcome-screen-customizer-js', 'zerifLiteWelcomeScreenCustomizerObject', $zerif_arg_array );
	}
	...
	public function zerif_lite_welcome_screen() {
		...
		<ul class="zerif-lite-nav-tabs" role="tablist">
			...
			<li role="presentation" class="zerif-lite-w-red-tab"><a href="#actions_required" aria-controls="actions_required" role="tab" data-toggle="tab"><?php esc_html_e( 'Recommended actions','zerif-lite'); ?></a></li>
