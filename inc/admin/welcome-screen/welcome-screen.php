...
class Zerif_Welcome {
	...
	public function zerif_lite_welcome_register_menu() {
		add_theme_page( 'About Zelle Lite', 'About Zelle Lite', 'activate_plugins', 'zerif-lite-welcome', array( $this, 'zerif_lite_welcome_screen' ) );
	}
	...
	public function zerif_lite_welcome_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php /* translators: Welcome page link */ echo sprintf( esc_html__( 'Welcome! Thank you for choosing Zelle Lite! To fully take advantage of the best our theme can offer please make sure you visit our %1$swelcome page%2$s.', 'zerif-lite' ), '<a href="' . esc_url( admin_url( 'themes.php?page=zerif-lite-welcome' ) ) . '">', '</a>' ); ?></p>
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=zerif-lite-welcome' ) ); ?>" class="button" style="text-decoration: none;"><?php _e( 'Get started with Zelle Lite', 'zerif-lite' ); ?></a></p>
			</div>
		<?php
	}
